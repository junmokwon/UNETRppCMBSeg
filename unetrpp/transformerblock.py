...
import torch
from unetrpp.dynunet_block import UnetResBlock
...
class TransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv52 = UnetResBlock(2, hidden_size, hidden_size, kernel_size=3, stride=1, norm_name="batch")
    ...
    def forward(self, x, mask=None):
        ...
        if mask is not None:
            mask_token = self.mask_token.expand(B, H * W, C)
