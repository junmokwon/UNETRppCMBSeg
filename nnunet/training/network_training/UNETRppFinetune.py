...
class UNETRppFinetune(nnUNetTrainerV2):
    ...
    def load_pretrained_weights(self):
        ...
        load_pretrained_weights(self.network, filename, verbose=True)
...
class UNETRppFinetunePatch32Ratio5(UNETRppFinetune):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.pretrained_trainer = 'UNETRppPretrainPatch32Ratio5'


class UNETRppFinetunePatch32Ratio6(UNETRppFinetune):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.pretrained_trainer = 'UNETRppPretrainPatch32Ratio6'


class UNETRppFinetunePatch64Ratio5(UNETRppFinetune):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.pretrained_trainer = 'UNETRppPretrainPatch64Ratio5'


class UNETRppFinetunePatch64Ratio6(UNETRppFinetune):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False):
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.pretrained_trainer = 'UNETRppPretrainPatch64Ratio6'
